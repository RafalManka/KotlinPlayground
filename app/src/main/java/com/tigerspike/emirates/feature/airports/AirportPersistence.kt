...
interface AirportDao {
    ...
    @Query("SELECT * FROM Airport WHERE UPPER(code) LIKE UPPER(:regex) OR UPPER(name) LIKE UPPER(:regex) OR UPPER(city) LIKE UPPER(:regex) OR UPPER(country) LIKE UPPER(:regex)")
